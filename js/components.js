...
var Impact = (function (_super) {
    ...
    Impact.prototype.render = function () {
        ...
        return (React.createElement("div", {"className": "container-fluid"}, React.createElement("div", {"className": "row"}, React.createElement("div", {"className": "col-lg-10 col-lg-offset-1 centered"}, React.createElement("img", {"width": "200px", "src": "img/logo_glossy.svg"})), React.createElement("div", {"className": "col-lg-4 col-lg-offset-4 col-md-8 col-md-offset-2 col-sm-12 centered"}, React.createElement("div", {"className": "input-group"}, React.createElement("input", {"type": "text", "className": "form-control", "value": term, "placeholder": "Search for...", "onChange": this.handleChange.bind(this)}), React.createElement("span", {"className": "input-group-btn"}, React.createElement("button", {"className": "btn btn-default", "type": "button"}, React.createElement("span", {"className": "glyphicon glyphicon-search"})))))), React.createElement("div", {"className": "list-group col-lg-6 col-lg-offset-3 rgroup col-md-12"}, relems)));
    };
    return Impact;
})(React.Component);
/// <reference path="./Index.tsx" />
